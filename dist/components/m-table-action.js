...
function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTableAction, [{
    ...
    value: function render() {
      ...
      var IconButtonComponent = action.fab ? _Fab["default"] : _IconButton["default"];
      var title = action.fab && action.title ? action.title : null;
      var button = React.createElement(IconButtonComponent, (0, _extends2["default"])({
      ...
      }, action.iconButtonProps || {}), typeof action.icon === 'string' ? React.createElement(_Icon["default"], action.iconProps, action.icon) : React.createElement(action.icon, (0, _extends2["default"])({}, action.iconProps, {
        disabled: action.disabled
      })), title);
